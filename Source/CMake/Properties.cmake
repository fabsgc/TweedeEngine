...
if(MSVC)
    ...
    set (CMAKE_CXX_FLAGS_RELWITHDEBINFO "${CMAKE_CXX_FLAGS_RELWITHDEBINFO} ${TE_COMPILER_FLAGS_COMMON} /GL /Gy /Zi /Od /Oi /Ot /MD -DDEBUG")
...
elseif (CMAKE_CXX_COMPILER_ID MATCHES "Clang")
    ...
    set (CMAKE_CXX_FLAGS_RELWITHDEBINFO "${CMAKE_CXX_FLAGS_RELWITHDEBINFO} ${TE_COMPILER_FLAGS_COMMON} -ggdb -Od -DDEBUG -Wno-unused-variable")
