...
namespace te
{
    ...
    SPtr<MeshSoftBody> BulletScene::CreateMeshSoftBody(const HSceneObject& linkedSO)
    {
        SPtr<MeshSoftBody> body = te_core_ptr_new<BulletMeshSoftBody>(_physics, this, linkedSO);
        body->SetThisPtr(body);
