...
namespace te
{
    ...
    void Editor::LoadEngineResources()
    {
        ...
        gBuiltinResources().GetBuiltinShader(BuiltinShader::ZPrepass);
        gBuiltinResources().GetBuiltinShader(BuiltinShader::Blit);
        gBuiltinResources().GetBuiltinShader(BuiltinShader::Skybox);
        gBuiltinResources().GetBuiltinShader(BuiltinShader::FXAA);
        gBuiltinResources().GetBuiltinShader(BuiltinShader::ToneMapping);
        gBuiltinResources().GetBuiltinShader(BuiltinShader::Bloom);
        gBuiltinResources().GetBuiltinShader(BuiltinShader::MotionBlur);
        gBuiltinResources().GetBuiltinShader(BuiltinShader::GaussianBlur);
        gBuiltinResources().GetBuiltinShader(BuiltinShader::Picking);
        gBuiltinResources().GetBuiltinShader(BuiltinShader::HudPicking);
        gBuiltinResources().GetBuiltinShader(BuiltinShader::Selection);
        gBuiltinResources().GetBuiltinShader(BuiltinShader::HudSelection);
        gBuiltinResources().GetBuiltinShader(BuiltinShader::BulletDebug);
        gBuiltinResources().GetBuiltinShader(BuiltinShader::SSAO);
        gBuiltinResources().GetBuiltinShader(BuiltinShader::SSAOBlur);
        gBuiltinResources().GetBuiltinShader(BuiltinShader::SSAODownSample);
        gBuiltinResources().GetBuiltinShader(BuiltinShader::Decal);
        gBuiltinResources().GetBuiltinShader(BuiltinShader::TextureDownsample);
        gBuiltinResources().GetBuiltinShader(BuiltinShader::TextureCubeDownsample);
        gBuiltinResources().GetBuiltinShader(BuiltinShader::ReflectionCubeImportanceSample);
        gBuiltinResources().GetBuiltinShader(BuiltinShader::IrradianceComputeSH);
        gBuiltinResources().GetBuiltinShader(BuiltinShader::IrradianceReduceSH);
        gBuiltinResources().GetBuiltinShader(BuiltinShader::IrradianceProjectSH);
        gBuiltinResources().GetBuiltinShader(BuiltinShader::BlitSelection);
        gBuiltinResources().GetBuiltinShader(BuiltinShader::ShadowDepthNormal);
        gBuiltinResources().GetBuiltinShader(BuiltinShader::ShadowDepthCube);
#endif
    }
