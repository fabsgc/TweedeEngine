...
namespace te
{
    class WidgetScene : public Widget
    {
    public:
        WidgetScene();
        virtual ~WidgetScene();
    ...
    protected:
        ...
        void CreateCamera(CoreType type);
        ...
        void CreateSoftBody(CoreType type);
        void CreateJoint(CoreType type);
        void CreateCollider(CoreType type);
        void CreateDecal();
        void Paste();
        void Delete();
