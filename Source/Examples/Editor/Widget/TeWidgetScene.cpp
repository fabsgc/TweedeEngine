...
namespace te
{
    ...
    void WidgetScene::UpdateBackground()
    { }

    void WidgetScene::ShowTree(HSceneObject& sceneObject)
    {
        OnTreeBegin();
    ...
    void WidgetScene::ShowSceneObjectTree(HSceneObject& sceneObject, bool expand)
    {
    ...
    void WidgetScene::ShowComponentsTree(HSceneObject& sceneObject)
    {
        auto components = sceneObject->GetComponents();
        _expandedToSelection = false;
    ...
    void WidgetScene::HandleClicking()
    {
    ...
    void WidgetScene::HandleKeyShortcuts()
    {
        if (gEditor().IsEditorRunning())
            return;
    ...
    void WidgetScene::HandleSelectionWindowSwitch()
    {
        auto& io = ImGui::GetIO();
    ...
    void WidgetScene::HandleDragAndDrop(HSceneObject& sceneObject)
    {
        if (gEditor().IsEditorRunning())
            return;
    ...
    void WidgetScene::HandleDragAndDrop(HComponent& component)
    {
        if (gEditor().IsEditorRunning())
            return;
    ...
    void WidgetScene::CreateDragPayload(const DragDropPayload& payload)
    {
    ...
    WidgetScene::DragDropPayload* WidgetScene::ReceiveDragPayload(DragPayloadType type)
    {
    ...
    void WidgetScene::SetSelectedSceneObject(SPtr<SceneObject> sceneObject)
    {
    ...
    void WidgetScene::SetSelectedComponent(SPtr<Component> component)
    {
    ...
    void WidgetScene::Popups()
    {
        PopupContextMenu();
    }

    void WidgetScene::PopupContextMenu()
    {
        if (gEditor().IsEditorRunning())
            return;
    ...
    void WidgetScene::CreateSceneObject()
    { 
    ...
    void WidgetScene::CreateRenderable(RenderableType type)
    {
    ...
    void WidgetScene::CreateLight(Light::Type type)
    { 
        if (!_selections.ClickedSceneObject || _selections.ClickedComponent)
            return;
    ...
    void WidgetScene::CreateAudioSource()
    { 
        if (!_selections.ClickedSceneObject || _selections.ClickedComponent)
            return;
    ...
    void WidgetScene::CreateAudioListener()
    { 
        if (!_selections.ClickedSceneObject || _selections.ClickedComponent)
            return;
    ...
    void WidgetScene::CreateAnimation()
    {
        if (!_selections.ClickedSceneObject || _selections.ClickedComponent)
            return;
    ...
    void WidgetScene::CreateRigidBody()
    {
        if (!_selections.ClickedSceneObject || _selections.ClickedComponent)
            return;
