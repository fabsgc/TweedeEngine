...
namespace te
{
    ...
    void Application::PostStartUp()
    {
        ...
        _loadedSponza = gResourceManager().Load<Mesh>("Data/Meshes/Sponza/sponza.dae", meshImportOptions);
        _loadedTextureSponza = gResourceManager().Load<Texture>("Data/Textures/Sponza/spnza_bricks_a_diff.png", textureImportOptions);

        TE_PRINT((_loadedSponza.GetHandleData())->data);
        TE_PRINT((_loadedSponza.GetHandleData())->uuid.ToString());

        TE_PRINT((_loadedTextureSponza.GetHandleData())->data);
        TE_PRINT((_loadedTextureSponza.GetHandleData())->uuid.ToString());
        // ######################################################
        ...
        _materialSponza = Material::Create(_shader);
        _materialSponza->SetName("Material");
        _materialSponza->SetTexture("DiffuseMap", _loadedTextureSponza);
        _materialSponza->SetSamplerState("AnisotropicSampler", samplerState);
        ...
        _sceneRenderableSponzaSO = SceneObject::Create("Cube");
        _renderableSponza = _sceneRenderableSponzaSO->AddComponent<CRenderable>();
        _renderableSponza->SetMesh(_loadedSponza);
        _renderableSponza->SetMaterial(_materialSponza);
        _renderableSponza->Initialize();
