...
namespace te
{
    enum TypeID_Core
    {
        ...
        TID_Font                      = 1408,
        TID_Mesh                      = 1409,
        TID_ZPrepassMesh              = 1410,
        TID_AudioClip                 = 1411,
        TID_Animation                 = 1413,
        TID_AnimationClip             = 1414,
        TID_PhysicsHeightField        = 1415,
        TID_PhysicsMesh               = 1416,

        TID_RigidBody                 = 1500,
        TID_SoftBody                  = 1501,
        TID_MeshSoftBody              = 1502,
        TID_RopeSoftBody              = 1503,
        TID_PatchSoftBody             = 1504,
        TID_CMeshSoftBody             = 1505,
        TID_EllipsoidSoftBody         = 1506,
        TID_CEllipsoidSoftBody        = 1507,
        TID_D6Joint                   = 1508,
        TID_HingeJoint                = 1509,
        TID_SliderJoint               = 1510,
        TID_SphericalJoint            = 1511,
        TID_ConeTwistJoint            = 1512,
        TID_BoxCollider               = 1513,
        TID_PlaneCollider             = 1514,
        TID_SphereCollider            = 1515,
        TID_CylinderCollider          = 1516,
        TID_CapsuleCollider           = 1517,
        TID_MeshCollider              = 1518,
        TID_ConeCollider              = 1519,
        TID_HeightFieldCollider       = 1520,
        TID_FSoftBody                 = 1521,
        TID_FPhysicsMesh              = 1522,
