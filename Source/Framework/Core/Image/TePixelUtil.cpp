...
#undef PCL_PAIR
    ...
    dds::DXGI_FORMAT PixelUtil::GetDXGIFormat(PixelFormat pf, bool gamma)
    {
        switch (pf)
        {
        case PF_R8:
            return dds::DXGI_FORMAT_R8_UNORM;
        case PF_R8S:
            return dds::DXGI_FORMAT_R8_SNORM;
        case PF_R8I:
            return dds::DXGI_FORMAT_R8_SINT;
        case PF_R8U:
            return dds::DXGI_FORMAT_R8_UINT;
        case PF_RG8:
            return dds::DXGI_FORMAT_R8G8_UNORM;
        case PF_RG8S:
            return dds::DXGI_FORMAT_R8G8_SNORM;
        case PF_RG8I:
            return dds::DXGI_FORMAT_R8G8_SINT;
        case PF_RG8U:
            return dds::DXGI_FORMAT_R8G8_UINT;
        case PF_BGR8:
            if (gamma)
                return dds::DXGI_FORMAT_B8G8R8X8_UNORM_SRGB;
            return dds::DXGI_FORMAT_B8G8R8X8_UNORM;
        case PF_RGB8:
        case PF_RGBA8:
            if (gamma)
                return dds::DXGI_FORMAT_R8G8B8A8_UNORM_SRGB;
            return dds::DXGI_FORMAT_R8G8B8A8_UNORM;
        case PF_RGBA8I:
            return dds::DXGI_FORMAT_R8G8B8A8_SINT;
        case PF_RGBA8U:
            return dds::DXGI_FORMAT_R8G8B8A8_UINT;
        case PF_RGBA8S:
            return dds::DXGI_FORMAT_R8G8B8A8_SNORM;
        case PF_BGRA8:
            if (gamma)
                return dds::DXGI_FORMAT_B8G8R8A8_UNORM_SRGB;
            return dds::DXGI_FORMAT_B8G8R8A8_UNORM;
        case PF_R16F:
            return dds::DXGI_FORMAT_R16_FLOAT;
        case PF_RG16F:
            return dds::DXGI_FORMAT_R16G16_FLOAT;
        case PF_RGBA16F:
            return dds::DXGI_FORMAT_R16G16B16A16_FLOAT;
        case PF_R32F:
            return dds::DXGI_FORMAT_R32_FLOAT;
        case PF_RG32F:
            return dds::DXGI_FORMAT_R32G32_FLOAT;
        case PF_RGB32F:
            return dds::DXGI_FORMAT_R32G32B32_FLOAT;
        case PF_RGBA32F:
            return dds::DXGI_FORMAT_R32G32B32A32_FLOAT;
        case PF_R16I:
            return dds::DXGI_FORMAT_R16_SINT;
        case PF_RG16I:
            return dds::DXGI_FORMAT_R16G16_SINT;
        case PF_RGBA16I:
            return dds::DXGI_FORMAT_R16G16B16A16_SINT;
        case PF_R16U:
            return dds::DXGI_FORMAT_R16_UINT;
        case PF_RG16U:
            return dds::DXGI_FORMAT_R16G16_UINT;
        case PF_RGBA16U:
            return dds::DXGI_FORMAT_R16G16B16A16_UINT;
        case PF_R32I:
            return dds::DXGI_FORMAT_R32_SINT;
        case PF_RG32I:
            return dds::DXGI_FORMAT_R32G32_SINT;
        case PF_RGB32I:
            return dds::DXGI_FORMAT_R32G32B32_SINT;
        case PF_R32U:
            return dds::DXGI_FORMAT_R32_UINT;
        case PF_RG32U:
            return dds::DXGI_FORMAT_R32G32_UINT;
        case PF_RGB32U:
            return dds::DXGI_FORMAT_R32G32B32_UINT;
        case PF_RGBA32U:
            return dds::DXGI_FORMAT_R32G32B32A32_UINT;
        case PF_R16S:
            return dds::DXGI_FORMAT_R16_SNORM;
        case PF_RG16S:
            return dds::DXGI_FORMAT_R16G16_SNORM;
        case PF_RGBA16S:
            return dds::DXGI_FORMAT_R16G16B16A16_SNORM;
        case PF_R16:
            return dds::DXGI_FORMAT_R16_UNORM;
        case PF_RG16:
            return dds::DXGI_FORMAT_R16G16_UNORM;
        case PF_RGBA16:
            return dds::DXGI_FORMAT_R16G16B16A16_UNORM;
        case PF_BC1:
        case PF_BC1a:
            if (gamma)
                return dds::DXGI_FORMAT_BC1_UNORM_SRGB;
            return dds::DXGI_FORMAT_BC1_UNORM;
        case PF_BC2:
            if (gamma)
                return dds::DXGI_FORMAT_BC2_UNORM_SRGB;
            return dds::DXGI_FORMAT_BC2_UNORM;
        case PF_BC3:
            if (gamma)
                return dds::DXGI_FORMAT_BC3_UNORM_SRGB;
            return dds::DXGI_FORMAT_BC3_UNORM;
        case PF_BC4:
            return dds::DXGI_FORMAT_BC4_UNORM;
        case PF_BC5:
            return dds::DXGI_FORMAT_BC5_UNORM;
        case PF_BC6H:
            return dds::DXGI_FORMAT_BC6H_UF16;
        case PF_BC7:
            if (gamma)
                return dds::DXGI_FORMAT_BC7_UNORM_SRGB;
            return dds::DXGI_FORMAT_BC7_UNORM;
        case PF_D32_S8X24:
            return dds::DXGI_FORMAT_D32_FLOAT_S8X24_UINT;
        case PF_D24S8:
            return dds::DXGI_FORMAT_D24_UNORM_S8_UINT;
        case PF_D32:
            return dds::DXGI_FORMAT_D32_FLOAT;
        case PF_D16:
            return dds::DXGI_FORMAT_D16_UNORM;
        case PF_RG11B10F:
            return dds::DXGI_FORMAT_R11G11B10_FLOAT;
        case PF_RGB10A2:
            return dds::DXGI_FORMAT_R10G10B10A2_UNORM;
        case PF_UNKNOWN:
        default:
            return dds::DXGI_FORMAT_UNKNOWN;
        }
    }
}
