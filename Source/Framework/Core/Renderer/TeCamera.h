...
namespace te
{
     ...
     */
    class TE_CORE_EXPORT Camera : public SceneActor, public CoreObject
    {
    public:
        ~Camera();
    ...
    protected:
        ...
        float _nearDist = 0.05f; /**< Clip any objects close than this. Smaller value decreases depth precision at larger depths. */
