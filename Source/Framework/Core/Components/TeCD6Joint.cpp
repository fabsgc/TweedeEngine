...
namespace te
{
    ...
    bool CD6Joint::Clone(const HComponent& c, const String& suffix)
    {
        if (c.Empty())
        {
        ...
        return Clone(static_object_cast<CD6Joint>(c), suffix);
    }
    ...
    void CD6Joint::ExportJson(nlohmann::json& document) const
    {
