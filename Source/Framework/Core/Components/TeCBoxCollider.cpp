...
namespace te
{
    ...
    bool CBoxCollider::Clone(const HComponent& c, const String& suffix)
    {
        if (c.Empty())
        {
        ...
        return Clone(static_object_cast<CBoxCollider>(c), suffix);
    }
    ...
    void CBoxCollider::ExportJson(nlohmann::json& document) const
    {
