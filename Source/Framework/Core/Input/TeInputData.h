...
#undef None
    ...
    enum ButtonCode : UINT32
    {
        ...
        TE_GAMEPAD_B,              // Similar to keyboard names, these are for convenience named after Xbox controller buttons
        TE_GAMEPAD_X,              // but if some other controller is connected you will need to learn yourself which of these
        TE_GAMEPAD_Y,              // corresponds to which actual button on the controller.
        TE_GAMEPAD_LB,
        TE_GAMEPAD_RB,
        TE_GAMEPAD_LS,
        TE_GAMEPAD_RS,
        TE_GAMEPAD_BACK,
        TE_GAMEPAD_START,
        TE_GAMEPAD_DPAD_LEFT,
        TE_GAMEPAD_DPAD_RIGHT,
        TE_GAMEPAD_DPAD_UP,
        TE_GAMEPAD_DPAD_DOWN,
        TE_GAMEPAD_BTN1,
        TE_GAMEPAD_BTN2,
        TE_GAMEPAD_BTN3,
        TE_GAMEPAD_BTN4,
        ...
        TE_NumKeys = TE_MEDIASELECT - TE_UNASSIGNED + 1, // IMPORTANT: Make sure to update these if you modify the values above
        TE_NumMouse = TE_MOUSE_BTN32 - TE_MOUSE_LEFT + 1,
        TE_NumGamepad = TE_GAMEPAD_DPAD_DOWNRIGHT - TE_GAMEPAD_A + 1,
        TE_Count = TE_NumKeys + TE_NumMouse + TE_NumGamepad,
    };
